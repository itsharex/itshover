                    ...
                    >
                        ...
                        <div className="flex justify-center gap-4">
                            <Button asChild size="lg" className="gap-2">
                                <Link href="https://twitter.com/intent/tweet?text=Check%20out%20this%20awesome%20animated%20icons%20library!%20%40yourhandle" target="_blank">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        <Button asChild className="w-full bg-[#FFDD00] text-black hover:bg-[#FFDD00]/90">
                            <Link href="https://buymeacoffee.com/yourusername" target="_blank">
                                Buy Me a Coffee
                            </Link>
                        </Button>
                    </SponsorCard>
                ...
                >
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-muted-foreground max-w-lg">
                            If you like this project, please give it a star on GitHub. It helps
                            more people discover the project and motivates me to build more!
                        </p>
    ...
    return (
        <div className="space-y-1.5">
            ...
            <div className="bg-muted/50 flex items-center justify-between rounded-md border px-3 py-2">
                <code className="truncate text-sm font-mono">{value}</code>
                <TooltipProvider>
                    <Tooltip>
