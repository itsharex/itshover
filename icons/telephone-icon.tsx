...
const StadiumIcon = ({
  ...
  const resetAnimation = async () => {
    ...
    animate(".stadium-roof", resetProps, resetOptions);
    animate(".stadium-pillar-left", resetProps, resetOptions);
    animate(".stadium-pillar-right", resetProps, resetOptions);
    animate(".stadium-center", resetProps, resetOptions);
    await animate(".stadium-bowl", resetProps, resetOptions);
  };
